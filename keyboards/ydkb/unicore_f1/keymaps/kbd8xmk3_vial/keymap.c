...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = {
    ...
    {KC_LEFT, KC_RCTRL, KC_RGUI, KC_DOT, KC_SLASH, KC_RSHIFT, KC_KP_2, KC_UP},
    {KC_NO, KC_QUOTE, KC_SCOLON, KC_L, KC_K, KC_J, KC_BSLASH/*KC_ENTER*/, KC_NO},
    {KC_ENTER/*KC_BSLASH*/, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET, KC_RBRACKET, KC_DELETE},
